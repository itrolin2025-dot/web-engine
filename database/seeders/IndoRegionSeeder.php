...
class IndoRegionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $data = [
            ...
            'Kalimantan Barat' => [
                'Kabupaten Bengkayang', 'Kabupaten Kapuas Hulu', 'Kabupaten Kayong Utara', 'Kabupaten Ketapang', 'Kabupaten Kubu Raya', 'Kabupaten Landak', 'Kabupaten Melawi', 'Kabupaten Mempawah', 'Kabupaten Sambas', 'Kabupaten Sangu', 'Kabupaten Sekadau', 'Kabupaten Sintang', 'Kota Pontianak', 'Kota Singkawang'
            ],
            'Kalimantan Tengah' => [
            ...
            'Maluku Utara' => [
                'Kabupaten Halmahera Barat', 'Kabupaten Halmahera Selatan', 'Kabupaten Halmahera Tengah', 'Kabupaten Halmahera Timur', 'Kabupaten Halmahera Utara', 'Kabupaten Kepulauan Sula', 'Kabupaten Pulau Morotai', 'Kabupaten Pulau Taliabu', 'Kota Ternate', 'Kota Tidore Kepulauan'
            ],
            'Papua' => [
                'Kabupaten Biak Numfor', 'Kabupaten Jayapura', 'Kabupaten Keerom', 'Kabupaten Kepulauan Yapen', 'Kabupaten Mamberamo Raya', 'Kabupaten Sarmi', 'Kabupaten Supiori', 'Kabupaten Waropen', 'Kota Jayapura'
            ],
            'Papua Barat' => [
            ...
            'Papua Pegunungan' => [
             ...
             'Papua Barat Daya' => [
                'Kabupaten Maybrat', 'Kabupaten Raja Ampat', 'Kabupaten Sorong', 'Kabupaten Sorong Selatan', 'Kabupaten Tambrauw', 'Kota Sorong'
            ]
        ];
        ...
        try {
            foreach ($data as $provinceName => $cities) {
                ...
                foreach ($cities as $cityName) {
                    $type = 'Kabupaten';
                    if (str_contains($cityName, 'Kota ')) {
                        $type = 'Kota';
                    } else if (str_contains($cityName, 'Kabupaten ')) {
                         // Remove 'Kabupaten ' prefix if desired, or keep it.
                         // Usually keep for official names, but separation is good.
                         // $cityName = str_replace('Kabupaten ', '', $cityName);
                    }
