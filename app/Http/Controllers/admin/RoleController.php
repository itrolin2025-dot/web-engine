...
class RoleController extends Controller
{
     ...
     */
    protected $modul        = "roles";
    protected $path         = "roles";
    protected $modul_name   = "Roles";
    protected $role_id;
    ...
    public function recycle()
    {
        if (canAccess($this->modul, $this->role_id, 'recycle') == false) {
            if (canAccess($this->modul, $this->role_id, 'view') == true) {
                // Use the exact route name, not from $this->modul, to prevent RouteNotFoundException
    ...
    public function create()
    {
        ...
        if (!canAccess($this->modul, $this->role_id, 'add')) {
            if (canAccess($this->modul, $this->role_id, 'view')) {
    ...
    public function getData(Request $request)
    {
        ...
        return DataTables::of($data)
            ...
            ->addColumn('action', function ($row) {
                ...
                if (canAccess('roles', $this->role_id, 'edit')) {
                ...
                if (canAccess('roles', $this->role_id, 'delete')) {
    ...
    public function restore($id){
        ...
        $dataPermissions = RolePermission::onlyTrashed()->where('role_id', $id)->get();
