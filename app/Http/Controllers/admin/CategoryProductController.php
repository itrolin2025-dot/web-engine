...
class CategoryProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            ActivityLogger::log(
                ...
                'create',
                $categoryProduct->id,
                ['name' => $categoryProduct->name, 'code' => $categoryProduct->code, 'customer_id' => $categoryProduct->customer_id],
                auth()->id()
            );
    ...
    public function update(Request $request, CategoryProduct $category_product)
    {
        ...
        try {
            ...
            ActivityLogger::log(
                ...
                'update',
                $category_product->id,
                ['name' => $category_product->name, 'code' => $category_product->code, 'customer_id' => $category_product->customer_id],
                auth()->id()
            );
    ...
    public function getData(Request $request)
    {
        ...
        $query = DB::table('category_products')
            ->leftJoin('customers', 'customers.id', '=', 'category_products.customer_id')
            ->select([
                'category_products.*',
