...
<body>
    ...
    <section class="hero">
        <div class="hero-slider-bg">
            <div class="hero-slide-bg"
                style="background-image: url('{{ asset('images/website/elska/hero-bg.png') }}');"></div>
            <div class="hero-slide-bg"
                style="background-image: url('{{ asset('images/website/elska/shop/hero-bg.png') }}');"></div>
        </div>
        <div class="hero-content">
            <div class="hero-badge">Newx</div>
    ...
    <!-- CAROUSEL SLIDER -->
    <!-- <section class="carousel-slider-container">
        <div class="carousel-wrapper">
            <div class="carousel-slide">
                <img src="{{ asset('images/website/elska/slide1.png') }}" alt="Slide 1">
            </div>
            <div class="carousel-slide">
                <img src="{{ asset('images/website/elska/slide2.png') }}" alt="Slide 2">
            </div>
            <div class="carousel-slide">
                <img src="{{ asset('images/website/elska/slide3.png') }}" alt="Slide 3">
            </div>
        </div>
