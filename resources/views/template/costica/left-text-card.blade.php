...
<section class="w-full bg-white font-sans text-[#1a1a1a]">
    <div class="w-full grid grid-cols-1 lg:grid-cols-2">
        <!-- Text Left (Order set for mobile responsiveness) -->
        <div
            class="bg-[{{ $background_color }}] flex flex-col items-center justify-center text-center p-8 md:p-16 lg:p-20 order-2 lg:order-1">
        ...
        <!-- Image Right -->
        <div class="relative min-h-[350px] md:min-h-[450px] lg:min-h-[500px] order-1 lg:order-2">
