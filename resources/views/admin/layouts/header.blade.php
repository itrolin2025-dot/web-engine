...
<nav class="header print:hidden">
    ...
    <div class="header-container relative flex w-full bg-white dark:bg-navy-700 print:hidden">
        ...
        <div class="flex w-full items-center justify-between">
            ...
            <div class="size-7">
                <button
                    class="sidebar-toggle cursor-pointer ml-0.5 flex size-7 flex-col justify-center space-y-1.5 text-primary outline-hidden focus:outline-hidden dark:text-accent-light/80">
                    <span></span>
                    <span></span>
                    <span></span>
                </button>
            ...
            <div class="-mr-1.5 flex items-center space-x-2">
                ...
                <div id="searchbar-wrapper" class="hidden sm:flex">
                    ...
                    <div id="searchbar-box" data-active-tab="#search-all" class="popper-root search-tab-wrapper"
                        style="position: absolute; inset: 0px 0px auto auto; margin: 0px; transform: translate(-234px, 58px);"
                        ...
                        <div
                            ...
                            <div
                                ...
                                <button
                                    class="tab btn shrink-0 rounded-none border-b-2 px-3.5 py-2.5 border-primary dark:border-accent text-primary dark:text-accent-light is-active"
                ...
                <button
                    ...
                    <svg class="darkmode-moon size-6 text-amber-400" fill="currentColor" viewBox="0 0 24 24">
                        <path
                            d="M11.75 3.412a.818.818 0 01-.07.917 6.332 6.332 0 00-1.4 3.971c0 3.564 2.98 6.494 6.706 6.494a6.86 6.86 0 002.856-.617.818.818 0 011.1 1.047C19.593 18.614 16.218 21 12.283 21 7.18 21 3 16.973 3 11.956c0-4.563 3.46-8.31 7.925-8.948a.818.818 0 01.826.404z">
                        </path>
                    </svg>
                    <svg xmlns="http://www.w3.org/2000/svg" class="darkmode-sun size-6 text-amber-400"
                ...
                <div id="notification-wrapper" class="flex">
                    ...
                    <div id="notification-box" class="popper-root"
                        style="position: absolute; inset: 0px 0px auto auto; margin: 0px; transform: translate(-98px, 58px);"
                        data-popper-placement="bottom-end">
                        <div
