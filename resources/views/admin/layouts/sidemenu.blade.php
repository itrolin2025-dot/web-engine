    ...
    <div class="main-sidebar">
        <div
            ...
            <div class="flex pt-4">
                <a href="/">
                    <div
                        class="w-8 h-8 overflow-hidden flex items-center justify-center rounded-full bg-white dark:bg-navy-800">
                        <img class="object-cover w-full h-full transition-transform duration-500 ease-in-out"
                            data-tooltip="Hi, {{ auth()->user()->staff->name ?? auth()->user()->name }} 👋"
                            data-placement="right" src="{{ asset('images/app-logo.png') }}" alt="logo" />
                    </div>
                </a>
            </div>
            ...
            <div class="is-scrollbar-hidden flex grow flex-col space-y-4 overflow-y-auto pt-6">
                <div class="flex flex-col items-center justify-center grow space-y-2">
                    ...
                    <a href="{{ route('admin.website') }}" data-tooltip="Website Template" data-placement="right"
                        class="flex size-11 items-center justify-center rounded-lg outline-hidden transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
            ...
            <div class="flex flex-col items-center space-y-3 py-3">
                ...
                <div id="profile-wrapper" class="flex">
                    <button id="profile-ref" class="avatar cursor-pointer size-12">
                        <img class="rounded-full" data-tooltip="Profile" data-placement="right"
                            src="{{ asset(auth()->user()->staff->photo ?? 'images/profile/default.png') }}"
                            alt="avatar" />
                        <span
                            ...
                            <div
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-slate-400 dark:text-navy-300">
                                        {{ auth()->user()->staff?->departemen?->name ?? '-' }}
                                    </p>
                                </div>
                            </div>
