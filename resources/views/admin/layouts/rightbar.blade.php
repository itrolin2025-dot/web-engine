          ...
          >
            <div class="flex items-center justify-between py-2 px-4">
              <p
                ...
                class="right-sidebar-header flex shrink-0 items-center space-x-1.5"
              >
                <svg
            ...
            <div
              ...
              class="tab-content tab-shift-up is-scrollbar-hidden overflow-y-auto overscroll-contain pt-1"
            >
              ...
              <div class="mt-3">
                ...
                <div
                  class="scrollbar-sm mt-3 flex space-x-4 overflow-x-auto px-3"
                >
                  <div
                    class="relative flex h-28 w-48 shrink-0 flex-col overflow-hidden rounded-xl bg-gradient-to-br from-purple-500 to-indigo-600 p-3"
                  >
                    <div class="grow">
                      <img
                        class="h-3"
                  ...
                  <div
                    class="relative flex h-28 w-48 shrink-0 flex-col overflow-hidden rounded-xl bg-gradient-to-br from-pink-500 to-rose-500 p-3"
                  >
                    <div class="grow">
                      <img
                        class="h-3"
                  ...
                  <div
                    class="relative flex h-28 w-48 shrink-0 flex-col overflow-hidden rounded-xl bg-gradient-to-br from-info to-info-focus p-3"
                  >
                    <div class="grow">
                      <img
                        class="h-3"
            ...
            <div
              ...
              class="tab-content tab-shift-up is-scrollbar-hidden overflow-y-auto overscroll-contain px-3 pt-1"
            >
              ...
              >
                ...
                <div class="mt-4">
                  ...
                  <p
                    class="mt-2 text-right text-xs-plus font-medium text-primary dark:text-accent-light"
                  >
                    25%
                  </p>
                </div>
            ...
            >
              ...
              >
                <button
                  ...
                  class="tab btn h-9 rounded-full py-0 px-4 hover:bg-slate-300/20 hover:text-primary focus:bg-slate-300/20 focus:text-primary active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:hover:text-accent dark:focus:bg-navy-300/20 dark:focus:text-accent dark:active:bg-navy-300/25"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
